 ...
 */
var g_popups_style = {
	'lock' : "style='z-index: 2147483646; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: #000; filter: alpha(opacity = 00); -moz-opacity: 0.00; opacity: 0.00; display: none;'",
	'mask' : "style='z-index: 2147483646; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: #000; filter: alpha(opacity = 42); -moz-opacity: 0.42; opacity: 0.42; display: none;'",
	'bkgr' : "style='z-index: 2147483644; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: #000; filter: alpha(opacity = 42); -moz-opacity: 0.42; opacity: 0.42; display: none;'",
	'tips' : {
		'ibox' : "style='z-index: 2147483647; position: fixed; width: 270px; left: 50%; font-family: serif; margin-left: -135px; color: #fff; background: #000; border-radius: 8px; filter: alpha(opacity = 75); -moz-opacity: 0.75; opacity: 0.75; font-size: 16px; display: none;'",
		'itxt' : "style='width: 88%; text-align: center; margin: 12px auto 12px auto;'",
	},
	'load' : {
		'ibox' : "style='z-index: 2147483647; position: fixed; width: 61.8%; height: 72px; line-height: 72px; top: 50%; left: 19.1%; margin-top: -36px; font-family: serif; font-size: 14px; border-radius: 8px 8px 8px 8px; background: #000; filter: alpha(opacity = 75); -moz-opacity: 0.75; opacity: 0.75; display: none;'",
	...
	'chio' : {
		'ibox' : "style='z-index: 2147483647; position: fixed; width: 270px; left: 50%; margin-left: -135px; font-family: serif; border-radius: 8px; background: #f8f8f8; display: none;'",
	...
	'pull' : {
		'ibox' : "style='z-index: 2147483645; position: fixed; bottom: 0px; left: 8px; right: 8px; font-family: serif; display: none;'",
	...
	'sbox' : {
		'ibox' : "style='z-index: 2147483645; position: fixed; width: 270px; left: 50%; margin: 0px; border-radius: 6px; margin-left: -135px; padding: 0px; list-style: none; font-family: serif; font-weight: normal; font-size: 16px; background: #f8f8f8; display: none;'",
