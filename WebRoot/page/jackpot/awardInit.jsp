...
<html>
  <head>
    ...
    <script type="text/javascript">
        ...
        function save(){
			...
			if(b && bb){
				$("#inputForm").attr("action", "${ctx}/jackpot/awardSave").ajaxSubmit({
					dataType: 'json',
					error : function() { 
  ...
  <body>
  	<form id="inputForm" action="${ctx}/jackpot/awardPage" method="post">
  		<input type="hidden" name="productId" value="${productId}" />
  		<input type="hidden" name="pageSize" value="8" />
    	<div id="content">
    		<div class="tool">
	    		<div class="sear">
	  				<input type="text" name="keyword" placeholder="输入奖品名称搜索"
