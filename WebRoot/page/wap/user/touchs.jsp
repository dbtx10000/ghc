...
<style type="text/css">
    ...
    */
    ...
    footer a{color:#fff;text-decoration:none;margin-left:9.6%;line-height:30px;font-size:1.4rem}
</style>
<script type="text/javascript">
	...
	function login(password) {
		...
		$.ios.ajax({
			...
			data : { 'username' : '${username}', 'touchsPassword' : password },
...
<footer>
    <a href="${ctx}/wap/user/slogin?openid=${openid}&redirect_uri=${redirect_uri}&back=true">使用账号密码登录</a>
</footer>
</body>
