...
<title>${snm}<c:if test="${!need_head}"> - 支付密码设置成功</c:if></title>
...
<section class="suc">
	<h3>恭喜支付密码设置成功</h3>
    <a class="login greenBg" href="${ctx}/wap/cnpay/sopen?openid=${openid}">绑定银行卡</a>
    <a class="login greenBg" href="${ctx}/wap/user/gotowx?openid=${openid}&from=register">进入我的账号</a>
</section>
</body>
