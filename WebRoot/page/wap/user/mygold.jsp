...
.listLink .sum{margin-right:30px;float:right;/*color:#fe4302;*/}
.vouchers {width:100%}
...
<section class="gold">
	<div class="num">
      <h3><span>${vaildIntegral}<em>个</em></span>金币总数</h3>
        <p>注：1金币 = 1元人民币</p>
    </div>
    <div class="listLink">
      <ul>
          <li><a href="${ctx}/wap/user/goldmy/1?openid=${openid}">邀请朋友<span class="sum">${integral_1 }个</span></a></li>
          <li><a href="${ctx}/wap/user/goldmy/2?openid=${openid}">小畅奖励<span class="sum">${integral_2 }个</span></a></li>
        </ul>
   </div>
</section>
<section class="vouchers" style="margin-top: -60px;">
  <div class="num" style="padding-top: 13px; height: 54px;">
    <h3><span>${fn:length(list)}<em>张</em></span>代金券</h3>
  </div>
  <ul id="vList">
