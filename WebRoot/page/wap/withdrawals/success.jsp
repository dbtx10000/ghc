...
<body>
  ...
  <section class="suc succeed">
    <p class="tip" style="text-align: center;">提现成功，提现金额${money}元,预计1个工作日内到账</p>
    <a class="confirm" href="${ctx}/wap/user/center?openid=${openid}">确认返回</a>
    <div class="service">
