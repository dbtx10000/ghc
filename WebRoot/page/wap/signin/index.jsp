...
<script>
	...
	function water(){
		...
		$("#blockbord").addClass('slideInDown');
		setTimeout(function(){
		...
		setTimeout(function(){
			...
			if ('${userId}' == '') {
				suc=true;
				var integral = parseInt(Math.random() * 10) + 1;
	...
	<div class="wrap">
		<section class="content">
			<section class="middle">
				<section class="left">
					<img src="${img}/signin/treechange.png" alt="" />
					<img id="bring" class="bring_animated bring infinite" src="${img}/signin/bling.png" alt="" />
				</section>
				<section class="right animated slideInDown " id="blackbord">
                	<h6><%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%></h6>
                	<p>${proverb}</p>
				</section>
				<section id="elephant" class="elephant animated slideInRight ">
					<!-- 浇水 start -->
					<a id="can" style="display:none" href="javascript:;" onclick="water()"><span>点我<br/>浇水</span></a>
					<!-- 浇水 end -->
					<!-- 不浇水 start -->
					<p id="cannot" style="display:none" class="nowater">每周二晚记得准时浇水哦~</p>
					<!-- 不浇水 end -->
					<img id="ele_animate" class="animated_ele" src="${img}/signin/elephant.png" alt="" />
					<img id="waterImg" class="animated_ele animate_delay" src="${img}/signin/water.png" alt="" />
				</section>
				<section style="position:absolute;bottom:10%;right:0%;width:40%;z-index:22">
			       <img style="margin-left:12%;width:76%" src="${img}/logo_tree.png" alt="" />
		        </section>
			</section>
